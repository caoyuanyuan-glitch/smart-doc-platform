...
**你不需要自己写代码！** Qwen 会直接帮你改！

### Qwen 自动修改代码

1. Qwen 理解你的需求后，会自动在右侧显示修改后的代码
2. 点击 **Apply**（应用）按钮，代码就自动改好了！
3. 按 **Ctrl + S** 保存文件

就这么简单！你不需要懂代码，Qwen 直接帮你改！
...
2. 用 VS Code 打开
    ↓
3. 在 VS Code 里打开 Qwen，告诉它要怎么改
    ↓
4. 点击 Apply，Qwen 自动改好代码
    ↓
5. 上传到 GitHub
```
