...
.col-content-compact :deep(.result-text-block) {
  white-space: pre-wrap;
}

.col-content-compact :deep(.result-auto-list) {
  margin: 0;
  padding-left: 20px;
  white-space: normal;
}

.col-content-compact :deep(.result-auto-list li) {
  margin: 0 0 8px;
  line-height: 1.75;
  white-space: pre-wrap;
}

.col-content-compact :deep(.result-auto-list li:last-child) {
  margin-bottom: 0;
}
