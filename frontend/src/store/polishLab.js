...
export const usePolishLabStore = defineStore('polishLab', () => {
  const DOCUMENT_DRAFT_KEY = 'polish-lab-document-draft-v2'
  const DOCUMENT_SESSION_KEY = 'polish-lab-document-session-v2'
