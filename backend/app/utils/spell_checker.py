...
TECH_TERMS_WHITELIST = {
    ...
    'MGISP', 'MGISP-960', 'MGISP-100', 'MGISP-NE32', 'MGISP-NE384', 'MGISP-NE384RS', 'MGISP-NEX',
    'MGISP-Smart', 'MGISTP-7000', 'MGICLab', 'MGICLab-FZ90', 'MGICLab-FZ150K',
    'MGISEQ', 'MGISEQ-200', 'MGISEQ-2000', 'DNBelab', 'DNBelab-D4RS', 'DIPSEQ', 'StereOmics', 'GenSIRO', 'DNBs', 'ssCir',
    ...
    'NVIDIA', 'GPU', 'GPUs', 'CPU', 'CPUs', 'CUDA', 'FASTQ', 'FASTQs', 'BCL', 'BCLs', 'SATA', 'NVMe',
    'SSD', 'SSDs', 'RAID', 'LAN', 'VLAN', 'IPv4', 'IPv6', 'DHCP', 'DNS', 'NAS', 'SAN', 'PCIe',
    'αCube', 'AlphaCube', 'DataCenter', 'datacenter', 'BioOS', 'ZLIMS', 'zLIMS',
    ...
    'Mr.', 'Mrs.', 'Ms.', 'Dr.', 'Prof.',
    'DNBSEQ-T20×2RS', 'DNBSEQ-T20×2', 'DNBSEQ-T10×4', 'DNBSEQ-T7', 'DNBSEQ-G99', 'DNBSEQ-G400', 'DNBSEQ-E25',
    'MGISP-Smart 8', 'CycloneSEQ', 'MegaBOLT', 'ZBOLT', 'OmicsNest', 'AlphaTool', 'PrepALL', 'RCR', 'OneStep', 'High-throughput',
    'T20×2', 'T10×4', 'T7+', 'T1+', 'G99', 'G10-FR', 'G100-ER', 'G400-ER', 'E25',
    'STP-3000', 'STP-7000', 'STP-B1000', 'SP-NE32', 'SP-NE384', 'SP-NEX', 'SP-100', 'SP-960', 'SP-Smart 8',
    'D4', 'FLP-L', 'FLP-L50', 'AIO', 'αCube', 'ZLIMS', 'ZSM', 'CLab-LT', 'CLab-FZ', 'CLab-FZ系列',
    'CLab-LN55K', 'CLab-LN55K Pro', 'CLab-Capper', 'Bloomics', 'PSS-B-01', 'DNBelabC-TaiM4',
...
def add_runtime_whitelist_term(term):
    return bool(add_runtime_whitelist_terms([term]))
...
def _get_spelling_suggestions(word):
    ...
    for candidate in spell.candidates(word) or []:
        ...
        if lowered == normalized or lowered in seen_lower:
            continue
