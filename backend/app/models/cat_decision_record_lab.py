...
class CatDecisionRecordLab(Base):
    __tablename__ = "cat_decision_record_lab"

    id = Column(Integer, primary_key=True, index=True)
    session_id = Column(Integer, ForeignKey("cat_analysis_session_lab.id"), index=True, nullable=True)
